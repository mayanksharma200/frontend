...
const ViewAllMid = () => {
  ...
  if (isLoading) {
    return (
      <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[...Array(8)].map((_, i) => (
          <SkeletonCard key={i} />
        ))}
      </div>
  ...
  return (
    <section className="py-12 px-4 sm:px-6 bg-white text-black max-w-6xl mx-auto">
      ...
      >
        <h2 className="text-3xl font-bold text-black mb-3">ALL TIPS</h2>
