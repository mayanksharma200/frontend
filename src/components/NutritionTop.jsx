  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 bg-gray-900 text-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Main featured article (larger card) */}
        {articles.length > 0 && (
          <div className="md:col-span-2 lg:col-span-1 bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-700 hover:border-purple-500 transition-colors duration-300">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-white-200 mb-2 hover:text-purple-100 transition-colors duration-300">
                {articles[0].title}
              </h3>
